...
library(stringr)
library(readr)
gene_info <- data <- read_tsv(gzfile("/media/sobp/Data10/Homo_sapiens.gene_info.gz"))
...
gene_sets <- read_gmt("/media/sobp/Data10/h.all.v2023.1.Hs.symbols.gmt")
...
# Use the function
gene_sets <- read_gmt("/media/sobp/Data10/h.all.v2023.1.Hs.symbols.gmt", symbol_to_id, synonyms_to_id)

# Print all gene sets
print_all_gene_sets(gene_sets)
write_gmt(gene_sets, "/media/sobp/Data10/Output.gmt")
